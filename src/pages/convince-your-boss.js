        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              ...
              <p>I&rsquo;m reaching out to request your help to attend an amazing conference, <a href="/index">REFACTR.TECH</a> in Atlanta, GA on August 13 - 14, 2020 <i>[August 12 - 14, 2020 if you want to include a workshop]</i>. The 2nd annual <a href="/index">REFACTR.TECH</a> is a tech conference that focuses on creating an inclusive environment, featuring marginalized people, and allies doing amazing work.</p>
