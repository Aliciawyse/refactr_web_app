        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              ...
              <p>I&rsquo;m reaching out to request your help to attend an amazing conference, <a href="/index">REFACTR.TECH</a> in Atlanta, GA on September 15 - 16, 2022 <i>[October 27, 2022 if you want to include a workshop]</i>. The 2nd annual <a href="/index">REFACTR.TECH</a> is a tech conference that focuses on creating an inclusive environment, featuring marginalized people, and allies doing amazing work.</p>
