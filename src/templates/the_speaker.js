...
export default ({ data }) => {
  return (
    <div>
        <Helmet>
        <title>{data.airtable.data.speaker_name + " | REFACTR.TECH 2020"}</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content={data.airtable.data.speaker_name + " | REFACTR.TECH 2020"}
        />
        <meta
        ...
        <meta itemprop="name" content={data.airtable.data.speaker_name + " | REFACTR.TECH 2020"} />
        <meta
